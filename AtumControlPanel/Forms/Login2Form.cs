...
namespace AtumControlPanel.Forms
{
    public class Login2Form : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            _txtServer = new ModernTextBox("DB Server IP", "127.0.0.1") { Dock = DockStyle.Top };
            _txtPort = new ModernTextBox("Port", "1433") { Dock = DockStyle.Top };
            _txtDbName = new ModernTextBox("Account Database", "atum2_db_account") { Dock = DockStyle.Top };
            _txtGameDbName = new ModernTextBox("Game Database", "atum2_db_1") { Dock = DockStyle.Top };
            _txtDbUser = new ModernTextBox("DB Username", "darkside") { Dock = DockStyle.Top };
            _txtDbPassword = new ModernTextBox("DB Password", "d4rksid3!!") { Dock = DockStyle.Top, UseSystemPasswordChar = true };
            ...
            _txtUsername = new ModernTextBox("Game Account Name", "daddy") { Dock = DockStyle.Top };
            _txtPassword = new ModernTextBox("Game Password", "123") { Dock = DockStyle.Top, UseSystemPasswordChar = true };
        ...
        private async void BtnLogin_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                using var testConn = new System.Data.SqlClient.SqlConnection(Config.GetGameConnectionString());
